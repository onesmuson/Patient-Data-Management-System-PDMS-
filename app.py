...
def dashboard():
    ...
    return render_template('dashboard.html', billing_count=billing_count,
                           appointment_count=appointment_count, history_count=history_count)
